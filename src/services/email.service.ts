...
export async function mailToken(token: string, address: string, emplyeeName: string, salary: number, phone: string, roleOrProfessions: string) {
  const send = await smtpTransport.sendMail({
    from: 'FreVice <frevice.hu@gmail.com',
    to: address,
    subject: 'FreVice Karbantartó-rendszeri regisztráció',
    html: `
...
<table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row container-padding" width="640" style="width:640px;max-width:640px;" Simpli>
  ...
  <tr>
    <td align="center" class="center-text">
      <img style="height:100px;border:0px;display: inline!important;" src="https://frevice.hu/frevice.png" width="120" border="0" editable="true" Simpli data-image-edit  Simpli alt="logo">
    </td>
  </tr>
  <tr>
    <td height="30" style="font-size:30px;line-height:30px;" Simpli>&nbsp;</td>
...
<v:fill type="frame" src="https://frevice.hu/frevice_stockphoto.png" color="#F4F4F4" />
...
<table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="width:100%;max-width:100%;">
  <tr>
    <td align="center" background="https://frevice.hu/frevice_stockphoto.png" data-bg-image   style="background-size:cover;background-position:center top; border-radius: 36px;">
      ...
      <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row container-padding" width="520" style="width:520px;max-width:520px;">
        ...
        <tr>
          <td class="center-text" Simpli align="center" style="font-family:'Catamaran',Arial,Helvetica,sans-serif;font-size:42px;line-height:54px;font-weight:700;font-style:normal;color:#333333;text-decoration:none;letter-spacing:0px;">
              <singleline>
                <div mc:edit Simpli>
                  ${emplyeeName}<br>
                  Regisztrálj a FreVice karbantartórendszerbe!
                </div>
              </singleline>
          </td>
        </tr>
        ...
        <tr>
          <td class="center-text" Simpli align="center" style="font-family:'Catamaran',Arial,Helvetica,sans-serif;font-size:16px;line-height:26px;font-weight:300;font-style:normal;color:#333333;text-decoration:none;letter-spacing:0px;">
              <singleline>
                <div mc:edit Simpli s style="color:#333333;text-decoration:none;">
                  Egy operátor felvett karbantartórendszerünkbe. Kérjük regisztráljon rendszerünkbe az alábbi opción keresztül.
                  Kérjük tekintse át adatai és ellenőrizze, ha hibát találna vegye fel egy operátorral a kapcsolatot a frevice.hu@gmail.com email
                  címen keresztül! <br><br>
                  <span style="font-weight: bold;color:#333333;text-decoration:none;">Telefonszám: </span><br>${phone}<br>
                  <span style="font-weight: bold;color:#333333;text-decoration:none;">Fizetés: </span><br>${salary} Ft<br>
                  <span style="font-weight: bold;color:#333333;text-decoration:none;">Feladatkör / Végzettségek: </span><br>${roleOrProfessions}<br>
                </div>
              </singleline>
          </td>
        </tr>
            ...
            <!--[if (gte mso 9)|(IE)]>
              <table border="0" cellpadding="0" cellspacing="0" align="center">
                <tr>
                  ...
                  <![endif]-->
                    <singleline>
                      <a href="localhost:4200/employee/$${token}" target="_blank" mc:edit  style="font-family:'Catamaran',Arial,Helvetica,sans-serif;font-size:16px;line-height:20px;font-weight:700;font-style:normal;color:#FFFFFF;text-decoration:none;letter-spacing:0px;padding: 15px 35px 15px 35px;display: inline-block;"><span>REGISZTRÁCIÓ</span></a>
                    </singleline>
                  <!--[if (gte mso 9)|(IE)]>
                  </td>
                  <td align="center" width="35"></td>
...
<table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row container-padding" width="520" style="width:520px;max-width:520px;">
  ...
  <tr>
    <td class="center-text" Simpli align="center" style="font-family:'Catamaran',Arial,Helvetica,sans-serif;font-size:24px;line-height:32px;font-weight:400;font-style:normal;color:#999999;text-decoration:none;letter-spacing:0px;">
        <singleline>
          <div mc:edit Simpli>
           Csatlakozz még ma <strong>#frevice</strong>
          </div>
        </singleline>
    </td>
  </tr>
      ...
      <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row" width="480" style="width:480px;max-width:480px;">
        <tr>
          <td class="center-text" Simpli align="center" style="font-family:'Catamaran',Arial,Helvetica,sans-serif;font-size:14px;line-height:24px;font-weight:480;font-style:normal;color:#666666;text-decoration:none;letter-spacing:0px;">
            <multiline>
              <div mc:edit Simpli>
                2022 FreVice Kft. Minden jog fentartva.<br>
                Péterfy Roland utca 69, Veszprém, 8200, Magyarország<br><br>
                Azért kapta ezt az emailt, mert karbantartónak jelentkezett cégünknél.
              </div>
            </multiline>
          </td>
        </tr>
